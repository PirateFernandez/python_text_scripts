...
"""input is a list of path+ctffind4.log and returns is a list of lines 'Thon rings with good fit up to  : XXXX'"""
		...
		with open(i, 'r') as object_file:
			...
			for i2 in file_lines:
				if 'Thon rings with good fit up to  :' in i2:
					res_list.append(i2)
	return res_list
"""store the list of lines with resolution values in list res_list_2"""
...
"""create a dictionary from to lists"""
"""map name of the ctffind4.log to the res value"""
...
"""print only those logs files with resolution values better than a especified number"""
