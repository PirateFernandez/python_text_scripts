...
u,v = np.loadtxt('fsc_post.csv', delimiter=',', unpack=True)
w,x= np.loadtxt('fsc_half1.csv', delimiter=',', unpack=True)
a,b= np.loadtxt('fsc_half2.csv', delimiter=',', unpack=True)
...
ax.plot(w,x,'b-o', linewidth=1.25, markersize=3.5)
ax.plot(a,b,'r-o', linewidth=1.25, markersize=3.5)
#.plot(c,d,'y-')
#ax.plot(c,d,'or-')
ax.hlines(0.5, 0, 0.6, linewidth=2, linestyle='--', color='grey')
...
plt.savefig("fsc_model_maps_job208_no_label_dpi_300.png", dpi=300)
plt.show()
#print(u)
